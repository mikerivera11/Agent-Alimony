...
export const INTAKE_STEPS: { [K in IntakeStepId]: IntakeStepConfig<IntakeDraftData[K] extends Partial<infer U> ? U : never> } = {
  ...
  parentingPlan: {
    ...
    summary: "The schedule and decision-making terms your parenting plan will set out.",
    whyWeAsk:
      "Florida requires a parenting plan in every case involving a minor child, and it must cover the time-sharing schedule, who decides about school and health care, and how your child stays in touch with each parent. These are decisions rather than calculations, so we record what you have settled and leave the rest open for you and an attorney.",
    schema: parentingPlanSchema,
    defaultValues: {
      planStatus: "proposed",
      schoolDesignationParent: "undecided",
      decisionMakingEducation: "undecided",
      decisionMakingHealthcare: "undecided",
