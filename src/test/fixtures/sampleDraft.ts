...
export function createSampleDraft(): IntakeDraft {
  ...
  draft.data = {
    ...
    parentingPlan: {
      ...
      holidaySchedule: "Winter break is divided at noon on December 26; spring break alternates annually.",
      ...
      holidaySchedules: [
        {
          ...
          oddYearParent: "you",
          beginEndTime: "Wednesday at 6:00 p.m. until Sunday at 6:00 p.m.",
          notes: "Receiving parent picks up from the other parent's home.",
        },
        {
          id: "major-christmas",
          name: "Christmas",
          ...
          beginEndTime: "December 24 at noon until December 26 at noon.",
          notes: "",
        },
        {
          id: "major-new-years",
          ...
          rotation: "alternating",
          oddYearParent: "you",
          beginEndTime: "December 31 at noon until January 2 at noon.",
          notes: "",
        },
      ],
      threeWeekendAdjustment: true,
